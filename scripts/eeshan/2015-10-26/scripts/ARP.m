...
%     end
    ...
    thetasestimated = firstestimate(thetaskeep);
    %thetasestimated(1) = 0;
    ...
    %E1 = norm(alpha_current, 1);
    %E2 = norm(I_current - iradon(Pgiven, thetasestimated),2);
    
    E_current = (norm(Pgiven - radon(I_current, thetasestimated),2)) ^ 2;
