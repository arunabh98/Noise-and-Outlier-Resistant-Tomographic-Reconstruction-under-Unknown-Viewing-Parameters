...
% % % % % % % 
% % % % % % % P_denoised1 = denoise( Pgiven, sigmaNoise, 50, 1000);
% % % % % % % %P_denoised2 = denoise2(Pgiven, sigmaNoise, 10, 1000);
% % % % % % % Pgiven = P_denoised1;
% % % % % % % 
...
for iteration = 1:numiter
    ...
    Ehlccpreviter = Ehlccvalues(ctr - (numkeep -1));
...
[expectedanswer thetasestimated thetasfirstestimate (expectedanswer - thetasestimated) (expectedanswer + thetasestimated)]
...
thetasestimated = mod(thetasestimated, 180);
