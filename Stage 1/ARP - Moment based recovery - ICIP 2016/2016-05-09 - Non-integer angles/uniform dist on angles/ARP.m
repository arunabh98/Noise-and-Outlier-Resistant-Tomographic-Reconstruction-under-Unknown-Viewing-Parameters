...
%     Ord = 2;
    ...
    %I= rgb2gray(imread('../images/200px-jurassicpark.jpg'));
    %I= rgb2gray(imread('../images/200px-napoleon.jpg'));
    ...
    PM12 = [M(:, 2); M(:, 3)]; % 1st, 2nd, 3rd order
    PMord = M(:,2:(Ord+1));
    ...
    for start = 1:numstarts
        ...
        IMestimated = A \ PM12; %<>% PM12 everywhere

        Ehlccvec = A * IMestimated - PM12; 
    ...
    %Checker
    a = mode((mod(expectedanswer - thetasestimated, 360)))
    b = mode((mod(expectedanswer + thetasestimated, 360)))
    ...
    e3
    e5
    numcorrect = char([num2str(e0), '/', num2str(e3), '/', num2str(e5)]);
