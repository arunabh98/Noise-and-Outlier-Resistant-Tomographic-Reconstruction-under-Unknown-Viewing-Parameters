...
ordercorrectness = zeros(numkeep, 1);
for i = 1:numkeep
    if abs(i - find(deducedorder == tsporder(i))) <= 2
        ordercorrectness(i) = 1
    else
%         defecit = defecit + 1;
    end
end

[tsporder, deducedorder, abs(tsporder- deducedorder), ordercorrectness]
